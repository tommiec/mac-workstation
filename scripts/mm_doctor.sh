...
for f in mm_common.sh mm_auto.sh mm_maintain.sh mm_install.sh mm_doctor.sh mm_triage.sh \
    mm_backup.sh mm_backup_ssh.sh mm_backup_gpg.sh mm_backup_git.sh mm_restore.sh mm_selftest.sh; do
